...
function Home() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <section className={cx(cardClass.base, 'overflow-hidden p-4 sm:p-8 lg:p-10')}>
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px] lg:gap-8">
          <div>
            <p className="section-kicker">EAM</p>
            <h1 className="mt-3 max-w-4xl font-display text-[clamp(2rem,1.55rem+2vw,3.25rem)] font-semibold tracking-tight text-brand-text">
              {t(
            ...
            <p className="mt-4 max-w-3xl text-[15px] leading-7 text-brand-brown sm:text-lg sm:leading-relaxed">
              {t(
      ...
      <section className="flex snap-x gap-4 overflow-x-auto pb-2 lg:grid lg:grid-cols-3 lg:overflow-visible lg:pb-0">
        {[
          ...
          <article key={item.title} className={cx(cardClass.base, 'min-w-[15.5rem] snap-start p-4 sm:min-w-[17.25rem] sm:p-5 lg:min-w-0')}>
      ...
      <section className={cx(cardClass.base, 'p-5 sm:p-8')}>
        ...
        <div className="mt-6 flex snap-x gap-4 overflow-x-auto pb-2 xl:grid xl:grid-cols-2 xl:overflow-visible xl:pb-0">
          {spotlightLessons.map((lesson) => (
            <article key={lesson.id} className={cx(cardClass.soft, 'min-w-[16.75rem] snap-start p-4 sm:min-w-[19rem] sm:p-5 xl:min-w-0')}>
