...
export default function SessionJournal() {
  ...
  return (
    <div className="relative min-h-[760px] overflow-hidden rounded-[36px] border border-white/10 bg-[#060811] p-5 text-white sm:p-7">
      ...
      <div className="relative z-10">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h2 className="sprechen-display text-4xl font-semibold text-white">Tes scenes laissees en memoire</h2>
        ...
        <div className="mt-8 grid gap-4">
          ...
          {entries.map((entry) => (
            <Card key={entry.id} tone="soft" className="p-5">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <h3 className="mt-4 sprechen-display text-2xl font-semibold text-white">{entry.themeLabel}</h3>
